class FakeMessageHandler:
    ...
    def process(self, message_type, messages):
        ...
        for message in messages:
            message["processed_by_fake_message_handler"] = True
        return messages 
        


def return_object(config={}, send_addresses={}, receive_addresses={}, message_configs={}):
    return FakeMessageHandler(config=config, send_addresses=send_addresses, receive_addresses=receive_addresses, message_configs=message_configs)
